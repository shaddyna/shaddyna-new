          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1">
              ...
              <input
                ...
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#bf2c7e] focus:border-transparent transition-all duration-300 pl-10 text-black"
                required
                placeholder="your@email.com"
              />
              <div className="absolute left-3 top-3.5 text-gray-400">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                value={password}
                onChange={(e) => setPassword(e.target.value)}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#bf2c7e] focus:border-transparent transition-all duration-300 pl-10 pr-10 text-black"
                required
                placeholder="••••••••"
              />
              <div className="absolute left-3 top-3.5 text-gray-400">
