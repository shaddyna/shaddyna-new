...
export default function MembershipPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/membership/membership`, {
        method: 'POST',
        headers: {
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-6 sm:p-8">
            <div className="text-center">
              <h1 className="text-2xl font-bold text-gray-900 mb-2">Upgrade to Member</h1>
              <p className="text-gray-600 mb-6">
                Complete your membership payment to create your shelf
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="text-sm text-gray-500">
                    One-time payment to activate your shelf creation account
                  </div>
                </div>
