      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl border border-gray-100">
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Start your collaborative journey</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1">
              <label className="block text-sm font-medium text-[#0f1c47]">Full Name</label>
          ...
          <div className="mt-6 text-center">
            <p className="text-[#0f1c47]">
              ...
              <Link href="/login" className="font-medium text-[#bf2c7e] hover:text-[#0f1c47] transition-colors">
                Sign In
              </Link>
            </p>
          </div>
